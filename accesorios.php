...
$resultado = mysqli_query($conexion, "SELECT img, nombre, precio FROM productos WHERE categoria = 'accesorio' AND ventas >= 5");
...
while ($producto = mysqli_fetch_assoc($resultado)) {
    ...
    echo '<a href="producto_ac.php" class="btn btn-primary">Ver productos</a>';
    echo '</div></div></div>';
